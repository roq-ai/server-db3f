...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'moderator', 'registered-user', 'guest-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Post Tags', path: '/post-tags', entity: 'post_tag', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Tags', path: '/tags', entity: 'tag', service: AccessServiceEnum.PROJECT, icon: FiTag },
