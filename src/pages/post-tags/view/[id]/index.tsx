...
import { getPostTagById } from 'apiSdk/post-tags';
import { PostTagInterface } from 'interfaces/post-tag';

function PostTagViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('post_tag', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/post-tags/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                {hasAccess('tag', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Tag"
                    text={
                      <Link as={NextLink} href={`/tags/view/${data?.tag?.id}`}>
                        {data?.tag?.name}
                      </Link>
                    }
                  />
