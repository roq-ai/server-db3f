  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Server: Empowering Communities with a Complete Forum Application. Create, Manage and Engage with Ease using HTML, CSS, PHP."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmb3J1bXxlbnwwfHx8fDE2OTUzMTgzMTV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Server: Empowering Communities with a Complete Forum Application. Create, Manage and Engage with Ease using HTML, CSS, PHP.`}
            </Text>
            <Box
